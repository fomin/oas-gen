...
public final class True {
    ...
    public static class Parser implements NonBlockingParser<com.example.True> {
        ...
        @Override
        public ParseResult<com.example.True> build() {
            switch (objectParserState) {
                case FINISHED_VALUE:
                    objectParserState = ObjectParserState.PARSE_START_OBJECT_OR_END_ARRAY_OR_NULL;
                    return new ParseResult.Value<>(new com.example.True(this.p0));
                case FINISHED_ARRAY:
                    objectParserState = ObjectParserState.PARSE_START_OBJECT_OR_END_ARRAY_OR_NULL;
    ...
    public static class Writer implements io.github.fomin.oasgen.Writer<com.example.True> {
        ...
        @Override
        public void write(JsonGenerator jsonGenerator, com.example.True value) throws IOException {
