...
public abstract class SimpleRoutes implements Consumer<HttpServerRoutes> {
    ...
    @Nonnull
    public abstract Mono<com.example.dto.Dto> simpleGet(@Nullable java.time.LocalDate xHeader, @Nonnull java.lang.String id, @Nonnull java.lang.String param1, @Nullable com.example.dto.Param2OfSimpleGet param2);
    ...
    public final void accept(HttpServerRoutes httpServerRoutes) {
        httpServerRoutes
            ...
            .get(baseUrl + "/path2/{id}", (request, response) -> {
                ...
                String param0Str = request.requestHeaders().get("X-header");
