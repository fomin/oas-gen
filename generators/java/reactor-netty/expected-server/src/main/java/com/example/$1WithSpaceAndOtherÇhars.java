...
public final class $1WithSpaceAndOtherÇhars {
    ...
    public static class Parser implements NonBlockingParser<com.example.$1WithSpaceAndOtherÇhars> {
        ...
        @Override
        public ParseResult<com.example.$1WithSpaceAndOtherÇhars> build() {
            switch (objectParserState) {
                case FINISHED_VALUE:
                    objectParserState = ObjectParserState.PARSE_START_OBJECT_OR_END_ARRAY_OR_NULL;
                    return new ParseResult.Value<>(new com.example.$1WithSpaceAndOtherÇhars(this.p0));
                case FINISHED_ARRAY:
                    objectParserState = ObjectParserState.PARSE_START_OBJECT_OR_END_ARRAY_OR_NULL;
    ...
    public static class Writer implements io.github.fomin.oasgen.Writer<com.example.$1WithSpaceAndOtherÇhars> {
        ...
        @Override
        public void write(JsonGenerator jsonGenerator, com.example.$1WithSpaceAndOtherÇhars value) throws IOException {
