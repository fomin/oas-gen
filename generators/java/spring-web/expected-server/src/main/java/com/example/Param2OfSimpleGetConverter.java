...
public final class Param2OfSimpleGetConverter {
    ...
    public static com.example.Param2OfSimpleGet parse(JsonNode jsonNode) {
    ...
    public static com.example.Param2OfSimpleGet parseString(String value) {
        switch (value) {
            case "value1":
                return com.example.Param2OfSimpleGet.VALUE1;
            case "value2":
                return com.example.Param2OfSimpleGet.VALUE2;
            default:
    ...
    public static List<? extends ValidationError> write(
            ...
            com.example.Param2OfSimpleGet value
    ) throws IOException {
