...
public final class DtoConverter {
    ...
    public static com.example.Dto parse(JsonNode jsonNode) {
        ...
        return new com.example.Dto(p0);
    }

    public static List<? extends ValidationError> write(JsonGenerator jsonGenerator, com.example.Dto value) throws IOException {
        List<ValidationError.ObjectFieldError> errors = null;
