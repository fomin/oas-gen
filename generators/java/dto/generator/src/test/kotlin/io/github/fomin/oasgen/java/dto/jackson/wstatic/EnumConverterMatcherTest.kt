...
internal class EnumConverterMatcherTest {
    ...
    @Test
    fun `matches object`() {
        val enumConverterMatcher = EnumConverterMatcher("com.example.dto", "com.example.routes")
    ...
    @Test
    fun `simple enum`() {
        val enumConverterMatcher = EnumConverterMatcher(
            "com.example.enumdto.dto",
            "com.example.enumdto.routes"
        )
        val converterRegistry = ConverterRegistry(
            CompositeConverterMatcher(
                listOf(
