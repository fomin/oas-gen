...
class CustomLocalDateTimeConverterMatcher : ConverterMatcher {
    class Provider : ConverterMatcherProvider {
        ...
        override fun provide(dtoPackage: String, routesPackage: String) = CustomLocalDateTimeConverterMatcher()
    }
        ...
        return if (jsonSchema.type is JsonType.Scalar.STRING && jsonSchema.format == "custom-local-date-time")
            object : ConverterWriter {
                ...
                override fun writeExpression(
                    ...
                    "io.github.fomin.oasgen.LocalDateTimeConverter.write($jsonGeneratorName, \"$pattern\", $valueExpression)"
