...
public final class Dto {
    ...
    public static class Parser implements NonBlockingParser<com.example.simple.Dto> {
        ...
        @Override
        public ParseResult<com.example.simple.Dto> build() {
            switch (objectParserState) {
                case FINISHED_VALUE:
                    objectParserState = ObjectParserState.PARSE_START_OBJECT_OR_END_ARRAY_OR_NULL;
                    return new ParseResult.Value<>(new com.example.simple.Dto(this.p0, this.p1));
                case FINISHED_ARRAY:
                    objectParserState = ObjectParserState.PARSE_START_OBJECT_OR_END_ARRAY_OR_NULL;
    ...
    public static class Writer implements io.github.fomin.oasgen.Writer<com.example.simple.Dto> {
        ...
        @Override
        public void write(JsonGenerator jsonGenerator, com.example.simple.Dto value) throws IOException {
