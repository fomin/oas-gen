...
public final class DtoConverter {
    ...
    public static com.example.javadoc.Dto parse(JsonNode jsonNode) {
        ...
        return new com.example.javadoc.Dto(p0, p1);
    }

    public static List<? extends ValidationError> write(JsonGenerator jsonGenerator, com.example.javadoc.Dto value) throws IOException {
        List<ValidationError.ObjectFieldError> errors = null;
