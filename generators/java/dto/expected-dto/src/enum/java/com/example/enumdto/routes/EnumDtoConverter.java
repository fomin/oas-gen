package com.example.enumdto.routes;
...
public final class EnumDtoConverter {
    ...
    public static com.example.enumdto.dto.EnumDto parse(JsonNode jsonNode) {
        ConverterUtils.checkNodeType(JsonNodeType.STRING, jsonNode);
        String textValue = jsonNode.textValue();
        return parseString(textValue);
    }

    public static com.example.enumdto.dto.EnumDto parseString(String value) {
        switch (value) {
            case "value1":
                return com.example.enumdto.dto.EnumDto.VALUE1;
            case "value2":
                return com.example.enumdto.dto.EnumDto.VALUE2;
            default:
    ...
    public static List<? extends ValidationError> write(
            ...
            com.example.enumdto.dto.EnumDto value
    ) throws IOException {
        jsonGenerator.writeString(value.strValue);
        return Collections.emptyList();
    }

    public static String writeString(com.example.enumdto.dto.EnumDto value) {
